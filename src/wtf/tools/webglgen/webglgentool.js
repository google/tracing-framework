...
/**
 * @fileoverview WebGL code generator tool.
 *
 * @author benvanik@google.com (Ben Vanik)
 */


goog.provide('wtf.tools.webglgen.WebGLGenTool');
 ...
 */
wtf.tools.webglgen.WebGLGenTool = function(platform) {
  goog.base(this, platform);
};
goog.inherits(wtf.tools.webglgen.WebGLGenTool, wtf.tools.Tool);


/**
 * @override
 */
wtf.tools.webglgen.WebGLGenTool.prototype.run = function(args) {
 ...
 * @private
 */
wtf.tools.webglgen.WebGLGenTool.prototype.buildArgTable_ = function() {
  var signatures = [
